...
<form role="form" method="post" action="php/cliente_actualizar_ccf.php">  
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" value="<?php echo $cliente->nit; ?>" name="nit" >
  </div>
  <div class="form-group">
    <label for="nrc">NRC</label>
    <input type="text" class="form-control" value="<?php echo $cliente->nrc; ?>" name="nrc" >
  </div>
  <div class="form-group">
    <label for="giro">GIRO</label>
    <input type="text" class="form-control" value="<?php echo $cliente->giro; ?>" name="giro" >
  </div>
  <div class="form-group">
